...
int  main()
{
	...
	*/
	int a, b, c;
	cin >> a;
	cout << (a % 10) + (a % 100 - a % 10) / 10 + (a - a % 100) /100 << endl;
	...
	*/
	...
	cin >> b1;
	cin >> c1;
	cout << (a1 * 3600 + b1 * 60 + c1) - (a * 3600 + b * 60 + c) << endl;
	/* Упражнение 3
	...
	*/
	cin >> a >> b >> c;
	int d((14 - b) / 12), y(c + 4800 - d), m(b + 12 * d - 3);
	cout << a + ((153 * m + 2) / 5) + (365 * y) + (y / 4) - (y / 100) + (y / 400) - 32045 << endl << endl;
	/* Упражнение 4
